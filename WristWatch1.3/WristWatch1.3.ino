...
#include <RTCZero.h>
//--------------------------------------------------------Pins in Proto
#define  upbuttonPin           4    //buttons
#define  downbuttonPin     1
#define  batteryreaderOutPin       3     //batteryvoltage
#define  batteryreaderInPin     2
#define  lightsensorVCCPin         5     //lightsensor
#define  lightsensorActivatePin     6
#define  lightsensorInPin     7
#define  ledactivatePin      10           //led
#define  leddataPin     0
...
byte brightness = 50; //regulates the brightness can be from 0 to 50
